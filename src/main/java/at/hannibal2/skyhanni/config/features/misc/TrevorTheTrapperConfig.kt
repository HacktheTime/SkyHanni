...
class TrevorTheTrapperConfig {
    ...
    @Expose
    @ConfigOption(
        name = "Talbot Theodolite Solver",
        desc = "Visualize the results of Talbot's Theodolite.\n" +
                "The greater the height difference, the more accurate."
    )
    @ConfigEditorBoolean
    @FeatureToggle
    var theodoliteSolver: Boolean = true
