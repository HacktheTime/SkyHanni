...
object InventoryUtils {
    ...
    fun clickSlot(slotNumber: Int, windowId: Int = InventoryCompat.getWindowId(), clickType: ContainerInput, mouseButton: Int = 0) {
        InventoryCompat.clickInventorySlot(windowId, mouseButton = mouseButton, mode = clickType, slotId = slotNumber)
    }
