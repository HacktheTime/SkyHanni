...
object DiscordRPCManager {
    ...
    private val startConfig = CoroutineSettings("discord RPC start", timeout = INFINITE).withIOContext()
    private val presenceConfig = CoroutineSettings("discord RPC updatePresence", timeout = INFINITE).withIOContext()
    private val readerConfig = CoroutineSettings("discord RPC reader", timeout = INFINITE).withIOContext()
    private val stopConfig = CoroutineSettings("discord RPC stop", timeout = INFINITE).withIOContext()
    private val manualStartConfig = CoroutineSettings("discord RPC manual start", timeout = INFINITE).withIOContext()
