...
import at.hannibal2.skyhanni.features.bingo.bingobrewers.official.KryoNetwork.ClientReceiveServerConstantValues
import at.hannibal2.skyhanni.features.bingo.bingobrewers.official.KryoNetwork.ClientSymmetricKey
import at.hannibal2.skyhanni.features.bingo.bingobrewers.official.KryoNetwork.ConnectionIGN
import at.hannibal2.skyhanni.features.bingo.bingobrewers.official.KryoNetwork.ServerPublicKey
import at.hannibal2.skyhanni.features.bingo.bingobrewers.official.KryoNetwork.ServerSendCHItems
import at.hannibal2.skyhanni.features.bingo.bingobrewers.official.ServerConnection.client
import at.hannibal2.skyhanni.features.bingo.bingobrewers.official.ServerConnection.connectionsThisSession
import at.hannibal2.skyhanni.features.bingo.bingobrewers.official.ServerConnection.decryptString
import at.hannibal2.skyhanni.features.bingo.bingobrewers.official.ServerConnection.encryptObjectPublicKey
import at.hannibal2.skyhanni.features.bingo.bingobrewers.official.ServerConnection.encryptString
import at.hannibal2.skyhanni.features.bingo.bingobrewers.official.ServerConnection.generateAESKey
import at.hannibal2.skyhanni.features.bingo.bingobrewers.official.ServerConnection.loadPublicKeyFromBase64
import at.hannibal2.skyhanni.features.bingo.bingobrewers.official.ServerConnection.reconnect
import at.hannibal2.skyhanni.features.bingo.bingobrewers.official.ServerConnection.sendTCP
        ...
        if (packet is ServerPublicKey) {
            ...
            SplashManager.addSplashAndDisplay(
                SplashData(
                    ...
                    packet.note?.joinToString(" ")!!,
                    false,
                    packet.serverID,
                    if (packet.isPrivate) null else SplashData.HubSelectorData(
                        packet.hub?.toInt()!!, if (packet.dungeonHub) Islands.DUNGEON_HUB else Islands.HUB,
                    ),
                ),
